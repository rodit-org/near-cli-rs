...
impl PrepaidGas {
    fn input_gas(
        ...
        Err(crate::common::non_interactive_input_required("prepaid gas for function call").into())
    }
}
...
impl Deposit {
    fn input_deposit(
        ...
        Err(crate::common::non_interactive_input_required("attached deposit for function call").into())
    }
}
